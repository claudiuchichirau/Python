...
class LoginWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding))  # Adaugă spațiere în partea de sus
        ...
        self.button_login.setStyleSheet("background-color: #37bfab; color: white;")  # Adaugă culoare butonului
        ...
        self.button_no_account.setStyleSheet("background-color: #BF3753; color: white;")  # Adaugă culoare butonului
